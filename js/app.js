  ...
  e_seat_name.forEach((seat) => {
    seat.addEventListener("click", () => {
      ...
      // faridpur seats
        ...
        e_popup_img.src = "https://i.ibb.co/V2T7WQj/Faridpur-1.jpg";
      } else if (seat.innerText === "ফরিদপুর-২") {
        e_popup_img.src = "https://i.ibb.co/7znHYnN/Faridpur-2.jpg";
      } else if (seat.innerText === "ফরিদপুর-৩") {
        e_popup_img.src = "https://i.ibb.co/FmfSTM3/Faridpur-3.jpg";
      } else if (seat.innerText === "ফরিদপুর-৪") {
        e_popup_img.src = "https://i.ibb.co/TBg1LdY/Faridpur-4.jpg";
      }

      // gazipur seats
      else if (seat.innerText === "গাজীপুর-১") {
        e_popup_img.src = "https://i.ibb.co/WsGB4Pj/Gazipur-1.jpg";
      } else if (seat.innerText === "গাজীপুর-২") {
        e_popup_img.src = "https://i.ibb.co/GkgZ6jg/Gazipur-2.jpg";
      } else if (seat.innerText === "গাজীপুর-৩") {
        e_popup_img.src = "https://i.ibb.co/RQvFVBN/Gazipur-3.jpg";
      } else if (seat.innerText === "গাজীপুর-৪") {
        e_popup_img.src = "https://i.ibb.co/GQ982N1/Gazipur-4.jpg";
      } else if (seat.innerText === "গাজীপুর-৫") {
        e_popup_img.src = "https://i.ibb.co/rdXdFf0/Gazipur-5.jpg";
      }

      // gopalganj seats
      else if (seat.innerText === "গোপালগঞ্জ-১") {
        e_popup_img.src = "https://i.ibb.co/XZLrhg1/Gopalgonj-1.jpg";
      } else if (seat.innerText === "গোপালগঞ্জ-২") {
        e_popup_img.src = "https://i.ibb.co/3fZp8N8/Gopalgonj-2.jpg";
      } else if (seat.innerText === "গোপালগঞ্জ-৩") {
        e_popup_img.src = "https://i.ibb.co/Jjddsn0/Gopalgonj-3.jpg";
      }

      // jamalpur seats
      else if (seat.innerText === "জামালপুর-১") {
        e_popup_img.src = "https://i.ibb.co/Vp4Bv3d/Jamalpur-1.jpg";
      } else if (seat.innerText === "জামালপুর-২") {
        e_popup_img.src = "https://i.ibb.co/cck1GFW/Jamalpur-2.jpg";
      } else if (seat.innerText === "জামালপুর-৩") {
        e_popup_img.src = "https://i.ibb.co/9HsRpz5/Jamalpur-3.jpg";
      } else if (seat.innerText === "জামালপুর-৪") {
        e_popup_img.src = "https://i.ibb.co/0hzCd18/Jamalpur-4.jpg";
      } else if (seat.innerText === "জামালপুর-৫") {
        e_popup_img.src = "https://i.ibb.co/sCnXDFm/Jamalpur-5.jpg";
      }
